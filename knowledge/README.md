...
| `webstudio/` | External-product DB: Webstudio website builder - agent/MCP integration, data/CMS patterns, design system, publishing, playbooks. Indexed by `engine.py`, gated by `verify_knowledge.py`; pull from here before building or editing any public-facing site. |
