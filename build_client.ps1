# Builds the standalone playable client: OsrsPlay.exe
...
& $py -m PyInstaller --onefile --windowed --name OsrsPlay `
...
Write-Host ""
Write-Host "Built dist\OsrsPlay.exe (keep it next to the osrs-llm-agent folder)"
