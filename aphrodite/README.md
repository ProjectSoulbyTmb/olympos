...
## Port registration (applied 2026-08-24)

`:43904` chosen as the free fleet slot (ptah=43903, daedalus=43905).
Registered in `realms/registry.json` (tier 2): sentinel and doctor now run
her 36-check gate on every sweep.
...
- **P3 (partial, v0.3.0)** — grid virtualization: every item renders a cheap
  ...
  Still open in P3: packaging polish (spec present, rebuild pending) and
  ratings/tags.
