...
Since Ironmen cannot trade, making money can be difficult. For example, a regular account could kill Zulrah, receive a tanzanite fang and then sell it to the Grand Exchange for 9,772,558, but an Ironman would only get 66,000 coins from its High Alchemy value.
