...
A lit lantern and a harpoon are required to fish at specific lantern harpooning fishing spots, only accessible with the Sailing skill, to catch swordtip squid and jumbo squid. A minimum Sailing level of  47  is required, enabling access to the spots at The Onyx Crest.
...
In addition to being able to be cooked for food or cut for offcuts like most fish, raw squid may also be crushed for squid paste, and cutting raw squid can rarely produce a squid beak in addition to the offcuts.
...
=== Karambwan vessels ===
Karambwan vessels can be obtained from Lubufu south of Brimhaven once a player has started the Tai Bwo Wannai Trio quest and they can be bought from Tiadeche's Karambwan Stall in Tai Bwo Wannai once they have completed the quest. Karambwan vessels are loaded with karambwanji, which are caught from the lake that is near Lubufu. Karambwan are caught at the north-east shore north of the Karamja Shipyard.
...
Deep sea trawling is a hybrid Fishing and Sailing activity, where players fish at trawling shoals using their boat's trawling nets.
...
=== Rada's blessing ===
Rada's blessing will give you an extra chance at catching a fish, with no additional experience granted, starting at 2% for the Rada's blessing 1 to 8% with the Rada's blessing 4.
...
=== Diabolic Worms ===
Diabolic worms, dropped by Yama, are a stronger alternative to sandworms that increase anglerfish catch success and give a 50% chance to speed up the next catch by one tick, but reduce experience from 120 to 79.2 per fish.


=== Shark Lures ===
Shark lures are a fishing enhancer used as bait to increase the success rate of catching raw sharks, consuming a set number per catch, usable in batches of 1, 3, or 5 with diminishing experience, and storable in a tackle box. They are dropped from certain bosses and chests, reduce the Heron pet drop rate, and their faster catch speed makes them one of the best methods for obtaining moon key loop halves and the big shark.
...
=== Angler's outfit ===
Obtained through the Fishing Trawler minigame and aerial fishing, pieces of the angler's outfit grant a bonus to Fishing XP gained, increasing to 2.5% with the full outfit. The spirit angler's outfit, created by bringing pieces of the angler's outfit and spirit flakes to Gita Prymes, is functionally identical, but also acts as a rope for tethering to totem poles and masts while battling Tempoross.


== Fishing spots ==

Players may fish at various fishing spots locate