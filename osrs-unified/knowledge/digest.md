...
|---|---|---|---|---|
| Black axe | 1006 | 941 | 973 | 40 |
| Bronze pickaxe | 67 | 66 | 66 | 40 |
| Copper ore | 11 | 10 | 10 | 13000 |
| Iron axe | 103 | 55 | 79 | 40 |
| Iron ore | 72 | 71 | 71 | 13000 |
| Iron pickaxe | 67 | 50 | 58 | 40 |
| Logs | 24 | 23 | 23 | 15000 |
| Mithril axe | 175 | 175 | 175 | 40 |
| Oak logs | 41 | 41 | 41 | 15000 |
| Raw shrimps | 23 | 20 | 21 | 15000 |
| Shrimps | 24 | 24 | 24 | 6000 |
| Steel axe | 239 | 195 | 217 | 40 |
| Steel pickaxe | 165 | 101 | 133 | 40 |
| Tin ore | 12 | 11 | 11 | 13000 |
| Willow logs | 21 | 22 | 21 | 15000 |
...
Players looking for a more social Woodcutting experience can partake in Forestry. To begin, grab a Forestry kit from the  Forestry Shop in Draynor, Seers' Village, Prifddinas, or Auburnvale.
Players chopping the same tree will be given an invisible Woodcutting bonus. Each player will receive a +1 boost to Woodcutting for each player at the tree, up to a maximum of +10 with ten players. This bonus does not get applied whilst chopping a normal tree, whilst in the Woodcutting Guild, or any tree grown through Farming. Like all invisible boosts, this does not allow one to do actions above their base level.
...
Dead yommi trees that may turn up during the Legends' Quest can be chopped for a random log. Notably, this allows players to obtain magic logs without the level requirement to chop magic trees.
The swaying tree is chopped for a branch during The Fremennik Trials.
The dramen tree is chopped for dramen branches during the Lost City quest and the Freeing Sir Amik Varze subquest of Recipe for Disaster.
Dream trees are chopped for dream logs during the Lunar Diplomacy quest.
Undead trees are chopped for undead twigs during Animal Magnetism. A blessed axe is required.
...
Phren roots are chopped for phren bark in The Gauntlet. A variant is chopped in the Corrupted Gauntlet.
Scrapey trees are chopped for scrapey tree logs in the Trouble Brewing minigame.
...
Saplings are chopped for kindling when fighting the ice demon in the Chambers of Xeric.
Regular and anima-infused roots are chopped during the Rising Roots Forestry Event.
...
Pickaxes, or "picks," are needed to mine rocks. They can be equipped as a weapon, giving players one extra space in their inventory. Pickaxes cannot be made using the Smithing skill. Pickaxes can be bought from mining shops or from other players.
A player's Mining level determines the type of pickaxe they can mine with. Higher-level pickaxes grant more frequent opportunities to obtain an ore from a rock but do not impact the success rate of doing so. As such, tick manipulation can be used to bypass the pickaxe mining speed. 
...
The celestial ring provides an invisible +4 boost to the player's Mining level. This boost does not allow the player to mine ore above their Mining level. When charged with stardust, it gives the player a 10% chance to obtain an extra ore from rocks up to adamantite.
...
Ring of wealth (i) doubles the chance to receive clue geodes when in the Wilderness.
...
There is a number of fish that can't be cooked, but instead most others offer some useful material when cut or smashed.


=== Clue in a bottle ===

While fishing, players may also occasionally receive clue bottles that contain a clue scroll of the following difficulties: beginner, easy, medium, hard, and elite. Master clue scrolls cannot be obtained from clue bottles.
...
Fernahei's Fishing Hut in Shilo Village
...
Cook on the Lumbridge Castle range after completion of Cook's Assistant, as there is a bank directly upstairs and the range offers a lower burn rate than other ranges on selected foods.
Cooking at the Rogues' Den has a permanent fire and is directly next to a banker (members only).
Consider completing Easy Kourend and Kebos diary for 5% increased chance to succeed cooking anything when cooking in Hosidius range and completing Family Crest quest to gain increased chance of cooking successfully on selected few raw foods.
...
A useful item to equip while training are cooking gauntlets. Wearing these gloves while training Cooking will cut down time and money due to less food being burnt. This is useful for food such as sharks where even at 99 you have the chance to burn them; with the cooking gauntlets equipped, you will stop burning sharks at level 94. Alternatively, cooking food while wearing a 
...
Cannot utilise storage within the Chambers of Xeric, including by logging out without claiming loot. Unique items are deleted and regular loot is dropped to the ground below the player upon logging in.
Can fill the looting bag from within the Ferox Enclave, just like other account types.
If the looting bag is destroyed within the Enclave, all items inside will be destroyed.


== Death mechanics ==
Cannot keep any items on death through any means, including through use of the Protect Item prayer. If killed in the Wilderness most items are converted into coins and, if applicable, dropped for the player who killed the Ultimate Ironman.
Cannot utilise graves, instead, their items will drop directly to the ground. Inside instances and the God Wars Dungeon items will still be put outside. Item retrieval services work as normal, with the exception of at Zulrah.
Ultimate Ironmen may always retrieve items for free from Zul-Gwenwynig, and do not have an interface to reclaim their items from. Items are instead given directly into the inventory when reclaimed.
...
Cannot utilise Death's Coffer for any reason.
...
On Tutorial Island, Paul can change a player's account mode to Ultimate Ironman mode. Once off of Tutorial Island, it is impossible to become an Ultimate Ironman. It is possible to "downgrade" an Ultimate Ironman to a normal Ironman, unranked Group Ironman, or regular account by talking to Adam in Lumbridge.
...
Use the banks of RuneScape. Players are still able to use noted items on bank booths, chests, or banknote merchants like Phials to unnote them.
...
Keep any items on death nor take advantage of the Protect Item prayer.
Use the seed vault.
Receive daily buckets of sand from Bert.
Withdraw partial sets from any of the hotspots in the costume room. However, players can store individual pieces of a set.
Store duplicate pieces in any of the hotspots in the costume room.
Use the storage units associated with the Chambers of Xeric to store supplies or unretrieved loot.
...
Like all Ironmen, UIM cannot receive rewards from group bosses when fought alongside other players, excluding the following exceptions:
...
Nex
Nightmare
The Forinthry Surge buff from Revenant maledictus
The Hueycoatl
Royal Titans
Yama
...
== General guides ==
Item Management - this page outlines all the options such as looting bags, Item Retrieval Services, the costume room, and various STASH units that UIMs use to store and manage their items.
Quests - some quests, such as those on Entrana, are particularly challenging for UIMs. This guide gives tips on these sorts of quests.
Minigames - some minigames like Barbarian Assault also have some restrictions on items, which can make them tricky to participate in as a UIM.
Ironman Moneymaking Guide - this guide, though aimed at regular Ironman players, also has some moneymaking methods that apply to UIMs. In general, it is recommended to aim for  55  early on, for access to High Level Alchemy as an efficient way to turn drops or other valuable items into coins.
...
Because of the limitations, it is sometimes best to stick to training one skill for a long period of time. Some skill training methods require a specific inventory l
...
== Limitations ==
Playing as an Ironman or Hardcore Ironman means you must be entirely self-sufficient.
...
== Overview ==
The game can be represented by three main unofficial phases: the early-game, mid-game, and late-game.
...
Occult necklace from Smoke devils
Amulet of rancour and Noxious halberd from Araxxor
Dragon hunter lance and Ferocious gloves from Alchemical Hydra
Infernal cape from the Inferno


=== Early skill training ===
Completing quests is the most efficient way for Ironmen to level skills in the early-game. This saves time by avoiding 
...
1.5-tick woodcutting teaks on Fossil Island is the fastest training method in the game. 1.5-tick woodcutting is done by setting up a 3-tick cycle (such as using swamp tar on a clean herb) and alternating tiles next to the hardwood patches. When timed cor
...
== Choosing a method ==
For the fastest route, complete early Mining quests, mine iron ore to level 45, and then use 3-tick granite. Players who do not want to use tick manipulation can continue mining iron to level 70 and switch to Volcanic Mine.
The table compares the major repeatable methods used after the earliest levels; questing and copper and tin mining are covered in the fastest-experience section below. The rates are approximate benchmarks stated in the relevant sections. Because rates vary with Mining level and setup, the XP/h entries state the principal conditions documented for each method. Attention required describes the frequency and precision of inputs, while complexity describes the setup, mechanics, and coordination needed. Both classifications are qualitative and may vary by strategy and player experience.
...
There are also mining gloves available in the Mining Guild. The expert mining gloves are 
...
Early levels can be skipped by completing quests that give Fishing experience. Completing Sea Slug, Fishing Contest, and the Freeing Pirate Pete quest of Recipe for Disaster will grant a total of 10,612 experience, which will get the player up to level 27. All of these quests have few requirements and can be done at a low level, and completing them is a better route for early Fishing levels than catching fish. Notably, the experience from Sea Slug alone is enough to get the player from level 1 to 24.
...
Without tick manipulation this method is only recommended as a low-effort alternative past level 35, as Tempoross offers faster experience. At level 47, drift net fishing becomes better than 3-tick fly fishing if the player also needs to train
...
Baking pies using the Bake Pie spell offers relatively fast experience at a low amount of effort. It also offers passive Magic experience, which can be useful for some players. This method can be expensive due to the low supply of uncooked pies, however. Some options may also not be viab
...
While free-to-play accounts have many limitations that members do not, free to play still contains many hours' worth of free and accessible gameplay.


=== Skills ===
Free-to-play accounts have access to 15 skills, with a maximum total level of 1493. Levels in members-only skills do not count towards entry into 500 Total Level and 750 Total Level free-to-play worlds, making the true requirements 509 and 759, respectively.
The skills are:
...
Telekinetic Grab
Tele Block
Bones to Bananas, Low Level Alchemy, High Level Alchemy, Monster Inspect, and Superheat Item
  Prayers are available up to level 45 Mystic Might.
The 1st floor of the Edgeville Monastery becomes available at level 31.
...
Soft leather items and hardleather body (the Coif is un-craftable in F2P but still obtainable through other players or the Champion's Guild shop)
Silver: holy symbols and tiaras
Gold, sapphire, emerald, ruby and diamond rings, necklaces and amulets
 Fishing and  Cooking
Available fish are: shrimp, anchovies, sardine, herring, trout, salmon, pike, tuna, lobster and swordfish. Guppy, cavefish, and tetra can be fished after completion of Below Ice Mountain.
...
Additional notable items include hill giant club, barronite mace, mooleta, ham joint, and shaman mask.


==== Ranged equipment ====
Ranging gear includes leather armour, studded leather armour and green dragonhide.
Normal, oak, willow, and maple bows are a
...
Caution: You should always research the items and methods before trying these methods. Because of constantly changing prices of items, the estimated profit may be inaccurate.
 Any method in the "Hourly Profit" section that relies on buying an item from the Grand Exchange does not take into account the time needed to purchase the item or its buy limit. Therefore, do not assume the rate of item purchases on the GE matches the rate of item processing of the method.
